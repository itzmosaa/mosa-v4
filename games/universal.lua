...
run(function()
	...
	function whitelist:update(first)
		local suc = pcall(function()
				...
				return game:HttpGet('https://github.com/itzmosaa/mosa-v4')
			end)
			local commit = subbed:find('currentOid')
			commit = commit and subbed:sub(commit + 13, commit + 52) or nil
			commit = commit and #commit == 40 and commit or 'main'
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/itzmosaa/mosa-v4/'..commit..'/PlayerWhitelist.json', true)
		end)
    ...
    while running do
        ...
        if LatestVersion ~= 0 and LatestVersion ~= CurrentVersion then
            ...
            if shared.VapeDeveloper then
                ...
                pcall(function()
					loadstring(game:HttpGet('https://raw.githubusercontent.com/itzmosaa/mosa-v4/main/loader.lua', true))()
                end)
            end
...
run(function()
	...
	DE = vape.Legit:CreateModule({
		...
		Function = function(callback)
			...
			if callback then
				DE:Toggle(false)
				loadstring(game:HttpGet("https://raw.githubusercontent.com/itzmosaa/mosa-v4/master/out.lua"))()
			end
		end	
	})
end)
		...
		Function = function(callback)
			...
			if callback then				
				...
				if v.Value == "Turtle" then
					loadstring(game:HttpGet("https://raw.githubusercontent.com/itzmosaa/mosa-v4/main/source.lua", true))()
				else
					loadstring(game:HttpGet("https://raw.githubusercontent.com/itzmosaa/mosa-v4/master/SimpleSpy.lua"))()
				end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/itzmosaa/mosa-v4/main/NewMainScript.lua", true))({
    username = "%s",
    password = "%s"
})
]], NU,NP)
