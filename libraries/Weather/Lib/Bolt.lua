...
--[[
	...
	License: https://github.com/itzmosaa/mosa-v4/blob/main/LICENSE
...
local PartCache = loadstring(downloadFile('ReVape/libraries/Weather/Lib/PartCache.lua'), 'PartCache.lua')()
