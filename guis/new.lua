...
local getcustomassets = {
	...
	['ReVape/assets/new/blockedtab.png'] = 'rbxassetid://14385672881',
	['ReVape/assets/new/blur.png'] = 'rbxassetid://14898786664',
	['ReVape/assets/new/blurnotif.png'] = 'rbxassetid://16738720137',
	['ReVape/assets/new/close.png'] = 'rbxassetid://14368309446',
	['ReVape/assets/new/closemini.png'] = 'rbxassetid://14368310467',
	...
	['ReVape/assets/new/expandright.png'] = 'rbxassetid://14368316544',
	['ReVape/assets/new/expandup.png'] = 'rbxassetid://14368317595',
	['ReVape/assets/new/friendstab.png'] = 'rbxassetid://14397462778',
	['ReVape/assets/new/guisettings.png'] = 'rbxassetid://14368318994',
	['ReVape/assets/new/guislider.png'] = 'rbxassetid://14368320020',
	['ReVape/assets/new/guisliderrain.png'] = 'rbxassetid://14368321228',
	['ReVape/assets/new/guiv4.png'] = 'rbxassetid://14368322199',
	['ReVape/assets/new/guivape.png'] = 'rbxassetid://14657521312',
	['ReVape/assets/new/info.png'] = 'rbxassetid://14368324807',
	['ReVape/assets/new/inventoryicon.png'] = 'rbxassetid://14928011633',
	['ReVape/assets/new/legit.png'] = 'rbxassetid://14425650534',
	...
	['ReVape/assets/new/profilesicon.png'] = 'rbxassetid://14397465323',
	['ReVape/assets/new/radaricon.png'] = 'rbxassetid://14368343291',
	['ReVape/assets/new/rainbow_1.png'] = 'rbxassetid://14368344374',
	['ReVape/assets/new/rainbow_2.png'] = 'rbxassetid://14368345149',
	['ReVape/assets/new/rainbow_3.png'] = 'rbxassetid://14368345840',
	['ReVape/assets/new/rainbow_4.png'] = 'rbxassetid://14368346696',
	['ReVape/assets/new/range.png'] = 'rbxassetid://14368347435',
	['ReVape/assets/new/rangearrow.png'] = 'rbxassetid://14368348640',
	['ReVape/assets/new/rendericon.png'] = 'rbxassetid://14368350193',
	['ReVape/assets/new/rendertab.png'] = 'rbxassetid://14397373458',
	['ReVape/assets/new/search.png'] = 'rbxassetid://14425646684',
	['ReVape/assets/new/targetinfoicon.png'] = 'rbxassetid://14368354234',
	['ReVape/assets/new/targetnpc1.png'] = 'rbxassetid://14497400332',
	['ReVape/assets/new/targetnpc2.png'] = 'rbxassetid://14497402744',
	['ReVape/assets/new/targetplayers1.png'] = 'rbxassetid://14497396015',
	['ReVape/assets/new/targetplayers2.png'] = 'rbxassetid://14497397862',
	['ReVape/assets/new/targetstab.png'] = 'rbxassetid://14497393895',
	['ReVape/assets/new/textguiicon.png'] = 'rbxassetid://14368355456',
	['ReVape/assets/new/textv4.png'] = 'rbxassetid://14368357095',
	['ReVape/assets/new/textvape.png'] = 'rbxassetid://14368358200',
...
local function addBlur(parent, notif)
	...
	blur.Image = getcustomasset('ReVape/assets/new/'..(notif and 'blurnotif' or 'blur')..'.png')
...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/itzmosaa/mosa-v4/'..readfile('ReVape/profiles/commit.txt')..'/'..select(1, path:gsub('ReVape/', '')), true)
		end)
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('ReVape/assets/new/colorpreview.png')
		...
		expand.Image = getcustomasset('ReVape/assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('ReVape/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('ReVape/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('ReVape/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('ReVape/assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('ReVape/assets/new/expandright.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('ReVape/assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('ReVape/assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('ReVape/assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('ReVape/assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('ReVape/assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('ReVape/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('ReVape/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('ReVape/assets/new/add.png')
	...
	TwoSlider = function(optionsettings, children, api)
		...
		knob.Image = getcustomasset('ReVape/assets/new/range.png')
		...
		arrow.BackgroundTransparency = 1
		arrow.Image = getcustomasset('ReVape/assets/new/rangearrow.png')
...
function mainapi:CreateGUI()
	...
	settingsicon.Image = getcustomasset('ReVape/assets/new/guisettings.png')
	...
	back.Image = getcustomasset('ReVape/assets/new/back.png')
	...
	function categoryapi:CreateBind()
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getcustomasset('ReVape/assets/new/edit.png')
	...
	function categoryapi:CreateOverlayBar()
		...
		button.AutoButtonColor = false
		button.Image = getcustomasset('ReVape/assets/new/overlaysicon.png')
		...
		icon.Position = UDim2.fromOffset(10, 13)
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('ReVape/assets/new/overlaystab.png')
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		expandicon.Image = getcustomasset('ReVape/assets/new/expandicon.png')
		...
		knob.BackgroundTransparency = 1
		knob.Image = getcustomasset('ReVape/assets/new/guislider.png')
		...
		local normalknob = getcustomasset('ReVape/assets/new/guislider.png')
		local rainbowknob = getcustomasset('ReVape/assets/new/guisliderrain.png')
		local rainbowthread
...
function mainapi:CreateCategory(categorysettings)
	...
	arrow.BackgroundTransparency = 1
	arrow.Image = getcustomasset('ReVape/assets/new/expandup.png')
	arrow.ImageColor3 = Color3.fromRGB(140, 140, 140)
	arrow.Rotation = 180
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('ReVape/assets/new/pin.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('ReVape/assets/new/customsettings.png')
			...
			if categorysettings.Profiles then
				...
				if ind then
					if val ~= 'default' then
						...
						if isfile('ReVape/profiles/'..val..mainapi.Place..'.txt') and delfile then
							delfile('ReVape/profiles/'..val..mainapi.Place..'.txt')
						end
					end
				else
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('ReVape/assets/new/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
	local close = addCloseButton(window)
	local children = Instance.new('ScrollingFrame')
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('ReVape/profiles/'..game.GameId..'.gui.txt') then
		guidata = loadJson('ReVape/profiles/'..game.GameId..'.gui.txt')
		if not guidata then
			guidata = {Categories = {}}
			self:CreateNotification('Onyx', 'Failed to load GUI settings.', 10, 'alert')
			savecheck = false
		end
	...
	if isfile('ReVape/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('ReVape/profiles/'..self.Profile..self.Place..'.txt')
		if not savedata then
			savedata = {Categories = {}, Modules = {}, Legit = {}}
			self:CreateNotification('Onyx', 'Failed to load '..self.Profile..' profile.', 10, 'alert')
			savecheck = false
		end
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('ReVape/assets/new/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('ReVape/assets/new/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('ReVape/assets/new/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('ReVape/assets/new/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('ReVape/assets/new/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('ReVape/assets/new/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('ReVape/assets/new/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Legit',
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('ReVape/assets/new/friendstab.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('ReVape/assets/new/profilesicon.png'),
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/itzmosaa/mosa-v4/'..readfile('ReVape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
...
VapeLogoV4.Image = getcustomasset('ReVape/assets/new/textv4.png')
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('ReVape/assets/new/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)
