	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('ReVape/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('ReVape/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('ReVape/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('ReVape/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('ReVape/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('ReVape/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('ReVape/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('ReVape/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('ReVape/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('ReVape/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('ReVape/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('ReVape/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('ReVape/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('ReVape/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('ReVape/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('ReVape/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('ReVape/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('ReVape/assets/old/textv4.png')
